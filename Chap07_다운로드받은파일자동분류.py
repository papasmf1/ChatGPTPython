...
# 다운로드 받은 폴더 경로 설정(본인 계정명으로 폴더이름을 수정해야 한다.)
download_folder = 'C:/Users/Jonathan/Downloads'

# 분류할 폴더 경로 설정(본인 계정명으로 폴더이름을 수정해야 한다.)
image_folder = 'C:/Users/Jonathan/Downloads/Images'
pdf_folder = 'C:/Users/Jonathan/Downloads/PDFs'
dataset_folder = 'C:/Users/Jonathan/Downloads/DataSets'
archive_folder = 'C:/Users/Jonathan/Downloads/Archives'
